...
class RleEncoder {
 public:
  ...
  static int64_t MinBufferSize(int bitWidth) {
    ...
    int64_t maxRepeatedRunSize =
        BitReader::kMaxVlqByteLength + ::arrow::bit_util::BytesForBits(bitWidth);
  ...
  static int64_t MaxBufferSize(int bitWidth, int64_t numValues) {
    ...
    int64_t minRepeatedRunSize =
        1 + ::arrow::bit_util::BytesForBits(bitWidth);
