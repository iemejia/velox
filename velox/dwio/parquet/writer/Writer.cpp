...
||||||| parent of 0061e3615 (refactor(parquet): Use writeRecordBatch instead of staging chunks and writeTable)
...
=======
    ...
    arrowContext_->schema = ::arrow::schema(newFields);
>>>>>>> 0061e3615 (refactor(parquet): Use writeRecordBatch instead of staging chunks and writeTable)
  }
